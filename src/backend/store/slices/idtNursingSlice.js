...
const idtNursingSlice = createSlice({
  ...
  initialState,
  reducers: {
    // 🔁 Section-switch fix: wipe ALL IDT nursing state when the selected
...
export const { setCurrentClient, clearErrors, clearSaveSuccess, setCurrentNote, clearCurrentNote } = idtNursingSlice.actions;
