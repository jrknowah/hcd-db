...
const create = async (reassessmentData) => {
  try {
    ...
    await pool.request()
      ...
      .input('reassessmentSources', sql.NVarChar, reassessmentData.reassessmentSources || null)
      .input('culturalCons', sql.NVarChar, reassessmentData.culturalCons || null)
      .input('physicalChall', sql.NVarChar, reassessmentData.physicalChall || null)
      .input('accessIssues', sql.NVarChar, reassessmentData.accessIssues || null)
      .input('reasonForRef', sql.NVarChar, reassessmentData.reasonForRef || null)
      .input('currentSymp', sql.NVarChar, reassessmentData.currentSymp || null)
      .input('suicHomiThou', sql.NVarChar, reassessmentData.suicHomiThou || null)
      .input('columbiaSR', sql.NVarChar, reassessmentData.columbiaSR || null)
      .input('columbiaSRComp', sql.VarChar, reassessmentData.columbiaSRComp || null)
      ...
      .input('cmObvSum', sql.NVarChar, reassessmentData.cmObvSum || null)
