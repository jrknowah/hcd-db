  ...
  return {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        {
          clipPath: "inset(0 0 1% 0 round 30px)",
        },
        ".rbc-today": {
        ...
        ".rbc-month-row + .rbc-month-row , .rbc-month-row + .rbc-month-row, .rbc-day-bg + .rbc-day-bg, .rbc-header, .rbc-month-view, .rbc-toolbar button, .rbc-time-content > * + * > *":
        {
          borderColor: `${theme.palette.divider} !important`,
        },
      },
